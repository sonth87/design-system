          ...
          <div className="overflow-x-auto">
            <table className="ds:w-full">
              <thead className="ds:border-b ds:bg-muted/50">
                <tr>
                  <th className="ds:h-12 ds:px-4 ds:text-left align-middle ds:font-medium">
                    <Checkbox />
                  </th>
                  <th className="ds:h-12 ds:px-4 ds:text-left align-middle ds:font-medium">
                    User
                  ...
                  <th className="ds:h-12 ds:px-4 ds:text-right align-middle ds:font-medium">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody>
                {users.map((user) => (
                  <tr key={user.id} className="ds:border-b ds:last:border-0">
                    <td className="ds:p-4 align-middle">
                      <Checkbox />
                    </td>
                    <td className="ds:p-4 align-middle">
                    ...
                    <td className="ds:p-4 align-middle ds:text-right">
