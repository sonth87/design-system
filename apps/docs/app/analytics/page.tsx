          ...
          {metrics.map((metric) => (
            ...
            >
              ...
              <div className="ds:mt-3">
                ...
                <p
                  className={`ds:mt-1 ds:text-sm ${metric.trend === "up" ? "ds:text-green-600" : "ds:text-red-600"}`}
                >
                ...
                <div className="ds:space-y-4">
                  <div className="ds:grid ds:gap-4 ds:md:grid-cols-2">
                    ...
                    <div className="ds:rounded-lg ds:border ds:bg-card ds:p-6 ds:shadow-sm">
                      ...
                      <div className="h-[300px] ds:flex ds:items-center ds:justify-center ds:border-2 ds:border-dashed ds:rounded-lg">
