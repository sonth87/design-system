...
function TourSpotlight(props: TourSpotlightProps) {
  ...
  return (
    <SpotlightPrimitive
      ...
      {...backdropProps}
      className={cn(
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 ds:fixed ds:inset-0 ds:z-40 ds:bg-black/80 data-[state=closed]:animate-out data-[state=open]:animate-in",
        className
      )}
      style={{
        clipPath: maskPath,
...
function TourSpotlightRing(props: TourSpotlightRingProps) {
  ...
  return (
    <RingPrimitive
      ...
      {...ringProps}
      className={cn(
        "ds:pointer-events-none ds:fixed ds:z-40 ds:border-ring ring-[3px] ds:ring-ring/50",
        className
      )}
      style={{
...
function TourClose(props: TourCloseProps) {
  ...
  return (
    <ClosePrimitive
      ...
      className={cn("ds:absolute ds:top-4 ds:right-4 ds:rounded-xs ds:opacity-70 ds:ring-offset-background ds:transition-opacity ds:hover:opacity-100 ds:focus:outline-hidden ds:focus:ring-2 ds:focus:ring-ring ds:focus:ring-offset-2 ds:disabled:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      onClick={onClick}
      {...closeButtonProps}
