...
const colorVariants = {
  primary: {
    trigger: "ds:data-[state=open]:bg-primary/10 ds:data-[state=open]:text-primary ds:data-[state=open]:rounded-b-none ds:data-[state=open]:border-primary/20",
    content: "ds:bg-primary/10 ds:rounded-b-md",
  },
  secondary: {
    trigger: "ds:data-[state=open]:bg-secondary/10 ds:data-[state=open]:text-secondary ds:data-[state=open]:rounded-b-none ds:data-[state=open]:border-secondary/20",
    content: "ds:bg-secondary/10 ds:rounded-b-md",
  },
  success: {
    trigger: "ds:data-[state=open]:bg-success/10 ds:data-[state=open]:text-success ds:data-[state=open]:rounded-b-none ds:data-[state=open]:border-success/20",
    content: "ds:bg-success/10 ds:rounded-b-md",
  },
  warning: {
    trigger: "ds:data-[state=open]:bg-warning/10 ds:data-[state=open]:text-warning ds:data-[state=open]:rounded-b-none ds:data-[state=open]:border-warning/20",
    content: "ds:bg-warning/10 ds:rounded-b-md",
  },
  error: {
    trigger: "ds:data-[state=open]:bg-error/10 ds:data-[state=open]:text-error ds:data-[state=open]:rounded-b-none ds:data-[state=open]:border-error/20",
    content: "ds:bg-error/10 ds:rounded-b-md",
  },
  glass: {
    trigger: "ds:data-[state=open]:bg-glass/10 ds:data-[state=open]:text-glass ds:data-[state=open]:rounded-b-none ds:data-[state=open]:border-glass/20",
