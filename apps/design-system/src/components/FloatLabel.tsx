      ...
      <Label
        className={cn(
          ...
          },
          {
            ...
            "top-0 scale-100 translate-x-0 w-[calc(100%-theme(spacing.4))] h-[calc(100%-theme(spacing.4))] py-3":
              typeof shouldFloat === "boolean" && !shouldFloat,
          },
      ...
      >
        ...
        {infoTooltip && (
          <Tooltip content={infoTooltip}>
            <Info className="size-3.5 min-w-3.5 absolute top-1/2 z-10 -translate-y-1/2 right-0" />
          </Tooltip>
        )}
      </Label>
    );
