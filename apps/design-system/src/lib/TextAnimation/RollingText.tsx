  ...
  return (
    <span data-slot="rolling-text" {...(props as any)} ref={ref}>
      {characters.map((char, idx) => (
        <span
          key={idx}
          className="ds:relative ds:inline-block perspective-[9999999px] ds:transform-3d ds:w-auto"
          aria-hidden="true"
        >
          <motion.span
            className="ds:absolute ds:inline-block ds:backface-hidden origin-[50%_25%]"
          ...
          <motion.span
            className="ds:absolute ds:inline-block ds:backface-hidden origin-[50%_100%]"
