...
export const WithLabel = (args: TextareaProps) => (
  <div className="ds:flex ds:flex-col ds:gap-4 w-[500px]">
    <Textarea
      {...args}
      label="Description"
...
export const WithInfoTooltip = (args: TextareaProps) => (
  <div className="w-[500px] ds:flex ds:flex-col ds:gap-4">
    <Textarea
      {...args}
      label="Message"
...
export const CompleteExample = () => (
  <div className="ds:flex ds:flex-col ds:gap-6 w-[600px]">
    <Textarea
      label="Feedback"
      placeholder=""
