...
const ItemCard = ({ item }: { item: ImageItem }) => (
  <div className="ds:relative overflow-hidden ds:rounded-lg ds:bg-white ds:shadow-md">
    <img
      src={item.imageUrl}
      alt={item.title}
      className="ds:w-full object-cover"
  ...
  render: () => (
    <div className="ds:p-4">
      ...
      >
        {items.map((item) => (
          <Masonry.Item key={item.id}>
            <div className="overflow-hidden ds:rounded-lg ds:bg-linear-to-br ds:from-purple-500 ds:to-pink-500 ds:p-4 ds:text-white ds:shadow-lg">
