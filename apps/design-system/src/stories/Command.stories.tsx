...
export const WithDialog = () => {
  ...
  return (
    <>
      ...
      >
        Press{" "}
        <div className="ds:bg-muted ds:text-muted-foreground ds:pointer-events-none ds:inline-flex ds:h-5 ds:items-center ds:gap-1 ds:rounded ds:border ds:px-1.5 ds:font-mono ds:text-[10px] ds:font-medium ds:opacity-100 ds:select-none">
...
export const Manual: Story = {
  render: () => (
    <Command className="ds:rounded-lg ds:border ds:shadow-md ds:md:min-w-[450px]">
