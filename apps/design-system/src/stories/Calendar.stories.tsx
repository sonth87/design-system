...
export const CustomDaysAndFormatters: Story = {
  render: function CustomDaysAndFormattersComponent() {
    const [range, setRange] = useState<DateRange | undefined>({
    ...
    return (
      <div className="ds:flex ds:flex-col ds:gap-4">
        <Calendar
          ...
          numberOfMonths={1}
          captionLayout="dropdown"
          className="ds:rounded-lg ds:border ds:shadow-sm ds:[--cell-size:--spacing(11)] ds:md:[--cell-size:--spacing(13)]"
          formatters={{
...
export const LocalizedCalendar: Story = {
  render: function LocalizedCalendarComponent() {
