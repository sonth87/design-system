    ...
    <div className="ds:flex ds:flex-col ds:gap-4">
      {colors.map((color) => (
        <div key={color} className="ds:flex ds:items-center ds:gap-4">
          <span className="ds:min-w-20 capitalize ds:text-sm ds:font-medium">
            {color}:
          </span>
          <Switch
            color={color}
    ...
    <div className="ds:flex ds:items-center ds:gap-4">
      {sizes.map((size) => (
        <div key={size} className="ds:flex ds:flex-col ds:items-center ds:gap-2">
          ...
          />
          <span className="capitalize ds:text-xs ds:font-medium">{size}</span>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <div className="ds:flex ds:flex-col ds:gap-6">
      ...
      <div className="ds:flex ds:flex-col ds:gap-2">
        ...
        <Switch className="data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-pink-500 data-[state=checked]:to-violet-500 data-[state=unchecked]:bg-gray-300 ds:border-none" />
      </div>
        ...
        <div className="ds:flex ds:flex-wrap ds:gap-4">
          {variants.map((variant) => (
            <div key={variant} className="ds:flex ds:flex-col ds:items-center ds:gap-2">
              ...
              />
              <span className="capitalize ds:text-xs ds:font-medium">{variant}</span>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="ds:flex ds:flex-wrap ds:gap-6">
          {colors.map((color) => (
            <div key={color} className="ds:flex ds:flex-col ds:items-center ds:gap-2">
              ...
              />
              <span className="capitalize ds:text-xs ds:font-medium">{color}</span>
            </div>
          ))}
        </div>
      </div>
...
const CustomSwitchComponent = () => {
  ...
  return (
    <div className="ds:border-input has-data-[state=checked]:border-primary/50 ds:relative ds:flex ds:w-full ds:items-start ds:gap-2 ds:rounded-md ds:border ds:p-4 ds:shadow-xs ds:outline-none">
      <div className="ds:flex grow ds:items-center ds:gap-3">
        <img
          src="https://cdn.shadcnstudio.com/ss-assets/brand-logo/github-icon.png?width=20&height=20&format=auto"
          alt="GitHub Icon"
          className="ds:size-5"
        />
        <label className="ds:grid grow ds:gap-2" htmlFor={id}>
