...
const VariantsComponent = (args: AccordionStoryProps) => {
  return (
    <div className="ds:w-[400px] ds:space-y-6">
      <div>
    ...
    <div className="ds:w-[400px] ds:space-y-6">
      ...
      <div>
        ...
        <Accordion
          ...
          items={defaultItems}
          defaultValue="item-1"
          triggerClassName="ds:data-[state=open]:bg-purple-500/10 ds:data-[state=open]:text-purple-500 ds:rounded-b-none"
          contentClassName="ds:bg-purple-500/10 ds:rounded-b-md"
        />
      </div>
    </div>
  );
