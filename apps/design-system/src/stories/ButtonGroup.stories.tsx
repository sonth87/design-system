...
export const IconButtons = (args: ButtonGroupProps) => (
  <div className="ds:flex ds:flex-col ds:gap-4">
    ...
    <ButtonGroup {...args}>
      <Button
        variant="outline"
        className="ds:group ds:w-20 ds:justify-start ds:gap-3 ds:overflow-hidden ds:rounded-none ds:rounded-l-md ds:shadow-none ds:transition-all ds:duration-200 ds:not-hover:w-10 ds:hover:bg-sky-500/10 ds:hover:text-sky-500 ds:focus-visible:z-10 ds:dark:hover:bg-sky-400/10 ds:dark:hover:text-sky-400"
      >
        <ThumbsUpIcon />
        Like
      </Button>
      <Button
        variant="outline"
        className="ds:hover:bg-destructive/10! ds:group ds:hover:text-destructive ds:w-24.5 ds:justify-end ds:gap-3 ds:overflow-hidden ds:rounded-none ds:rounded-r-md ds:shadow-none ds:transition-all ds:duration-200 ds:not-hover:w-10 ds:focus-visible:z-10"
      >
        Dislike
        <ThumbsDownIcon />
      </Button>
...
export const GlassEffect = (args: ButtonGroupProps) => (
  <div
    className="ds:w-200 ds:h-60 ds:p-4 ds:flex ds:items-center ds:justify-center ds:bg-cover ds:[animation:move-background_400s_linear_infinite] ds:gap-4"
    style={{
      backgroundImage:
