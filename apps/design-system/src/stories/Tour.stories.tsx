...
export function Manual() {
  ...
  return (
    <div className="ds:flex min-h-[400px] ds:flex-col ds:items-center ds:justify-center ds:gap-8 ds:p-8">
      ...
      <div className="ds:flex ds:w-full ds:flex-col ds:gap-6">
        ...
        {open && value >= 2 && (
          <div
            ...
            className="fade-in ds:slide-in-from-bottom-4 ds:animate-in ds:rounded-lg ds:border ds:border-primary/50 ds:bg-primary/5 ds:p-6 ds:text-center ds:duration-300"
          >
