...
export const Vertical: Story = {
  ...
  render: (args) => (
    <div className="ds:h-[400px] ds:w-[600px] ds:rounded-lg ds:border">
      <Resizable {...args} />
    </div>
  ),
};
...
export const CustomHandleIcon: Story = {
  args: {
    ...
    withHandle: true,
    handleIcon: (
      <span className="ds:text-[8px] ds:-rotate-90 ds:h-fit ds:w-fit ds:px-2 ds:py-1 ds:bg-muted ds:hover:bg-primary ds:rounded-xl ds:z-10">
        Custom
      </span>
    ),
    panels: [
...
export const NestedPanels: Story = {
  ...
  render: (args) => (
    <div className="ds:h-[500px] ds:w-[800px] ds:rounded-lg ds:border">
      <Resizable {...args} />
    </div>
  ),
};
...
export const IDELayout: Story = {
          ...
          <div className="ds:flex ds:h-full ds:flex-col ds:bg-muted/30">
            ...
            <div className="ds:flex-1 ds:p-2">
              <div className="ds:space-y-1">
                <div className="ds:px-2 ds:py-1 ds:text-sm ds:rounded ds:hover:bg-accent ds:cursor-pointer">
                  📁 src
                </div>
                <div className="ds:px-2 ds:py-1 ds:text-sm ds:rounded ds:hover:bg-accent ds:cursor-pointer ds:ml-4">
                  📁 components
                </div>
                <div className="ds:px-2 ds:py-1 ds:text-sm ds:rounded ds:hover:bg-accent ds:cursor-pointer ds:ml-4">
                  📄 index.ts
  ...
  render: (args) => (
    <div className="ds:h-[600px] ds:w-[1000px] ds:rounded-lg ds:border ds:bg-background ds:overflow-hidden">
      <Resizable {...args} />
    </div>
  ),
  parameters: {
    ...
    const Component = () => {
      ...
      return (
        <div className="ds:space-y-4">
          ...
          <div className="ds:h-[300px] ds:w-[600px] ds:rounded-lg ds:border">
            <Resizable direction="horizontal">
              <Resizable.Panel
                ref={panelRef}
                defaultSize={30}
