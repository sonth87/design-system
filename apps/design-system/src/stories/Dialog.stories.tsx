  ...
  render: () => (
    <div className="ds:flex ds:flex-wrap ds:gap-4">
      <Dialog
        ...
        headerClassName="ds:!bg-gradient-to-r ds:!from-purple-500 ds:!to-pink-500 ds:!text-white ds:rounded-t-md"
        titleClassName="ds:text-xl ds:font-bold"
        descriptionClassName="ds:text-white/90"
        contentClassName="ds:!border-2 ds:!border-purple-500 ds:overflow-hidden ds:rounded-b-md"
      >
        <div>
          <p className="ds:text-sm">
      ...
      <Dialog
        ...
        className="ds:to-card ds:bg-linear-to-b ds:from-sky-100 ds:to-40% ds:bg-size-[100%_101%] ds:sm:max-w-sm ds:dark:from-sky-900"
        footer={
          <div className="ds:flex ds:gap-2 ds:justify-end ds:w-full">
            <Button
              variant="outline"
