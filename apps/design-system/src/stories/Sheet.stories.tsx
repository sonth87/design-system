  ...
  render: () => (
    <div className="ds:flex ds:flex-wrap ds:gap-4">
      <Sheet
        ...
        headerClassName="ds:!bg-gradient-to-r ds:!from-purple-500 ds:!to-pink-500 ds:!text-white"
        titleClassName="ds:text-xl ds:font-bold"
        descriptionClassName="ds:text-white/90"
      >
        <div>
      ...
      <Sheet
        ...
        footerClassName="ds:!bg-gray-100 ds:dark:!bg-gray-800"
        footer={
      ...
      <Sheet
        ...
        contentClassName="ds:!bg-gradient-to-b ds:!from-sky-100 ds:!to-white ds:dark:!from-sky-900 ds:dark:!to-card"
        headerClassName="ds:!bg-transparent"
        titleClassName="ds:text-2xl ds:font-bold"
        descriptionClassName="ds:text-base"
        footer={
          <div className="ds:flex ds:gap-2 ds:justify-end ds:w-full">
            <SheetClose asChild>
              <Button variant="outline">Cancel</Button>
    ...
    return (
      <div className="ds:flex ds:flex-wrap ds:gap-4">
        <Sheet
          ...
          overlayClassName="ds:bg-gradient-to-r ds:from-purple-500 ds:via-pink-500 ds:to-red-500 ds:opacity-80"
        >
          <div className="ds:py-4">
            <p className="ds:text-sm">
        ...
        <Sheet
          ...
          title="Custom Overlay Sheet"
          description="This sheet uses a custom overlay style."
          overlayClassName="ds:backdrop-blur-sm"
        >
          <div className="ds:py-4">
            <p className="ds:text-sm">
              The overlay behind this sheet has a vibrant gradient background.
        ...
        <Sheet
          ...
          title="Custom Overlay Sheet"
          description="This sheet uses a custom overlay style."
          className="ds:to-card ds:bg-gradient-to-b ds:from-green-100 ds:to-40% ds:[background-size:100%_101%] ds:sm:max-w-sm ds:dark:from-green-900"
        >
          <div className="ds:py-4">
            <p className="ds:text-sm">
              The overlay behind this sheet has a vibrant gradient background.
