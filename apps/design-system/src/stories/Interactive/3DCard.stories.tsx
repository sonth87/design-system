...
export const Default: Story = {
  render: () => (
    <CardContainer className="inter-var" containerClassName="py-8">
      <CardBody className="ds:bg-gray-50 ds:relative group/card ds:dark:hover:shadow-2xl ds:dark:hover:shadow-emerald-500/10 ds:dark:bg-black ds:dark:border-white/20 ds:border-black/10 ds:w-auto sm:w-[24rem] ds:h-auto ds:rounded-xl ds:border ds:p-4">
        <CardItem
          translateZ="50"
        ...
        <CardItem translateZ="100" className="ds:w-full ds:mt-4">
          <img
            ...
            height="1000"
            width="1000"
            className="ds:h-48 ds:w-full object-cover ds:rounded-xl ds:group-hover/card:shadow-xl"
            alt="thumbnail"
          />
        </CardItem>
...
export const ComplexExample: Story = {
  render: () => (
    <CardContainer className="inter-var" containerClassName="py-8">
      <CardBody className="ds:bg-gray-50 ds:relative group/card ds:dark:hover:shadow-2xl ds:dark:hover:shadow-emerald-500/10 ds:dark:bg-black ds:dark:border-white/20 ds:border-black/10 ds:w-auto sm:w-[24rem] ds:h-auto ds:rounded-xl ds:p-4 ds:border">
        <CardItem
          translateZ="50"
          className="ds:text-xl ds:font-bold ds:text-neutral-600 ds:dark:text-white"
        >
