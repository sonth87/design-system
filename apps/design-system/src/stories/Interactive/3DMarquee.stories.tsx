...
export const Default: Story = {
  ...
  render: (args) => (
    <div className="ds:h-[300px] ds:overflow-hidden ds:rounded-2xl ds:mx-auto">
      <ThreeDMarquee {...args} />
    </div>
  ),
};
...
export const HeroDemo: Story = {
  ...
  render: (args) => (
    <div className="ds:relative ds:mx-auto ds:my-10 ds:flex ds:h-screen ds:w-full ds:max-w-7xl ds:flex-col ds:items-center ds:justify-center ds:overflow-hidden ds:rounded-3xl">
      <h2 className="ds:relative ds:z-20 ds:mx-auto ds:max-w-4xl ds:text-center ds:text-2xl ds:font-bold ds:text-balance ds:text-white ds:md:text-4xl ds:lg:text-6xl">
        ...
        <span className="ds:relative ds:z-20 ds:inline-block ds:rounded-xl ds:bg-blue-500/40 ds:px-4 ds:py-1 ds:text-white ds:underline ds:decoration-sky-500 ds:decoration-[6px] ds:underline-offset-[16px] ds:backdrop-blur-sm">
          moment
        </span>{" "}
        at a time.
      </h2>
