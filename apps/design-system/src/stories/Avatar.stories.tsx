  ...
  render: (args) => (
    <div className="ds:flex ds:items-center ds:gap-4">
      <div className="ds:relative ds:w-fit">
        <Avatar {...args} />
        <span className="ds:border-background ds:bg-destructive ds:absolute -right-0.5 -bottom-0.5 ds:size-3 ds:rounded-full ds:border-2">
      ...
      <div className="ds:relative ds:w-fit">
        ...
        />
        <span className="ds:absolute -right-1.5 -bottom-1.5 ds:rounded-full ds:bg-green-600 ds:dark:bg-green-400">
      ...
      <div className="ds:relative ds:w-fit">
        <Avatar {...args} variant="square" />
        <span className="ds:absolute -top-2.5 -right-1.5">
      ...
      <div className="ds:relative ds:w-fit">
        <Avatar {...args} />
        <Badge className="ds:absolute -top-1.5 -right-2.5 ds:h-5 ds:min-w-5 ds:rounded-full ds:bg-red-500 ds:px-1 ds:border ds:border-white">
          +99
        </Badge>
      </div>
    </div>
