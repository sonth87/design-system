    ...
    <ScrollArea className="ds:w-96 ds:whitespace-nowrap ds:rounded-md ds:border">
      <div className="ds:flex ds:w-max ds:space-x-4 ds:p-4">
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="ds:shrink-0 ds:rounded-md ds:border w-[200px] h-[200px] ds:flex ds:items-center ds:justify-center"
          >
...
export const BothDirections: Story = {
  render: () => (
    <ScrollArea className="h-[400px] w-[400px] ds:rounded-md ds:border">
      <div className="ds:p-4">
          ...
          {Array.from({ length: 20 }).map((_, i) => (
            <div key={i} className="ds:flex ds:space-x-4">
              {Array.from({ length: 10 }).map((_, j) => (
                <div
                  key={j}
                  className="ds:shrink-0 ds:rounded-md ds:border w-[120px] h-[120px] ds:flex ds:items-center ds:justify-center"
                >
...
export const LongTextContent: Story = {
  render: () => (
    <ScrollArea className="h-[300px] w-[500px] ds:rounded-md ds:border ds:p-4">
    ...
    <ScrollArea className="ds:h-48 ds:w-56 ds:rounded-md ds:border">
      <div className="ds:p-2">
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="ds:px-2 ds:py-1.5 ds:text-sm ds:hover:bg-accent ds:hover:text-accent-foreground ds:rounded-sm cursor-pointer"
          >
            Option {i + 1}
          </div>
        ))}
...
export const ImageGallery: Story = {
  render: () => (
    <ScrollArea className="h-[400px] w-[600px] ds:rounded-md ds:border">
...
export const ChatMessages: Story = {
  render: () => (
    <ScrollArea className="h-[400px] w-[350px] ds:rounded-md ds:border ds:bg-background">
      <div className="ds:p-4 ds:space-y-4">
        {Array.from({ length: 20 }).map((_, i) => {
          ...
          return (
            ...
            >
              <div
                className={`max-w-[70%] ds:rounded-lg ds:px-3 ds:py-2 ds:text-sm ${ isMe ? "bg-primary ds:text-primary-foreground" : "bg-muted ds:text-muted-foreground" }`}
              >
                <p>
...
export const SnapVertical: Story = {
  render: () => (
    <ScrollArea
      className="h-[400px] ds:w-64 ds:rounded-md ds:border"
    ...
    >
      <div className="ds:p-4">
        ...
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="snap-start h-[120px] ds:mb-4 ds:rounded-lg ds:bg-linear-to-br ds:from-blue-100 ds:to-purple-100 ds:dark:from-blue-950 ds:dark:to-purple-950 ds:flex ds:items-center ds:justify-center ds:border"
          >
...
export const SnapHorizontal: Story = {
  render: () => (
    <ScrollArea
      className="w-[500px] ds:whitespace-nowrap ds:rounded-md ds:border"
    ...
    >
      <div className="ds:flex ds:p-4 ds:gap-4">
        {Array.from({ length: 15 }).map((_, i) => (
          <div
            key={i}
            className="snap-center ds:shrink-0 w-[300px] h-[200px] ds:rounded-lg ds:bg-linear-to-r ds:from-pink-100 ds:to-orange-100 ds:dark:from-pink-950 ds:dark:to-orange-950 ds:flex ds:items-center ds:justify-center ds:border"
          >
            <div className="ds:text-center">
...
export const SnapProximity: Story = {
  render: () => (
    <ScrollArea
      className="h-[400px] ds:w-80 ds:rounded-md ds:border"
    ...
    >
      <div className="ds:p-4">
        ...
        {Array.from({ length: 15 }).map((_, i) => (
          <div
            key={i}
            className="snap-center h-[150px] ds:mb-4 ds:rounded-lg ds:bg-linear-to-br ds:from-green-100 ds:to-teal-100 ds:dark:from-green-950 ds:dark:to-teal-950 ds:flex ds:items-center ds:justify-center ds:border"
          >
            <div className="ds:text-center">
...
export const SnapCarousel: Story = {
  render: () => (
    <div className="ds:space-y-4">
      ...
      <ScrollArea
        className="w-[600px] ds:whitespace-nowrap ds:rounded-md ds:border overflow-hidden"
        snapType="x mandatory"
      >
        <div className="ds:flex">
          {Array.from({ length: 10 }).map((_, i) => (
            <div
              key={i}
              className="snap-start ds:shrink-0 ds:w-full h-[300px] ds:flex ds:items-center ds:justify-center"
              style={{
    ...
    <ScrollArea {...args}>
      <div className="ds:p-4">
        ...
        {Array.from({ length: 15 }).map((_, i) => (
          <div
            key={i}
            className="snap-center h-[150px] ds:mb-4 ds:rounded-lg ds:bg-linear-to-br ds:from-indigo-100 ds:to-cyan-100 ds:dark:from-indigo-950 ds:dark:to-cyan-950 ds:flex ds:items-center ds:justify-center ds:border"
          >
            <div className="ds:text-center">
