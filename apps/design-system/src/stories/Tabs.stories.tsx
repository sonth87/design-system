            ...
            <div className="ds:space-y-2">
              ...
              <div className="ds:space-y-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="ds:p-3 ds:rounded-md ds:border ds:hover:bg-accent ds:cursor-pointer"
                  >
...
export const CardStyle: Story = {
  render: () => {
    ...
    return (
      <Tabs defaultActiveKey="pricing" items={items} className="ds:w-[500px]" />
    );
  },
};
...
export const Minimal: Story = {
  render: () => {
    ...
    return (
      <Tabs defaultActiveKey="today" items={items} className="ds:w-[400px]" />
    );
  },
};
...
export const WithBadges: Story = {
  render: () => {
    ...
    return (
      <Tabs defaultActiveKey="inbox" items={items} className="ds:w-[500px]" />
    );
  },
};
...
export const TabPositions: Story = {
  render: () => {
    ...
    return (
      <div className="ds:space-y-8 ds:w-[600px]">
        <div>
...
export const DisabledTabs: Story = {
  render: () => {
    ...
    return <Tabs defaultActiveKey="1" items={items} className="ds:w-[400px]" />;
  },
};
...
export const CustomColor: Story = {
  render: function CustomColorTabs() {
    ...
    return (
      <div className="ds:w-[600px] ds:space-y-4">
        <div className="ds:flex ds:items-center ds:gap-4">
          ...
          <input
            ...
            className="ds:w-12 ds:h-8 ds:border ds:rounded ds:cursor-pointer"
          />
          ...
          <div>
            ...
            >
              <Tabs
                ...
                items={items}
                variant="pill-stroke"
                tabTriggerClassName="ds:[&[data-state=active]]:border-[var(--custom-color)] ds:[&[data-state=active]]:text-[var(--custom-color)]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            >
              <Tabs
                ...
                items={items}
                variant="text"
                tabTriggerClassName="ds:[&[data-state=active]]:text-[var(--custom-color)]"
              />
            </div>
          </div>
        </div>
