        ...
        {sampleImages.map((img, index) => (
          ...
          >
            <img
              src={img.src}
              alt={img.alt}
              className="ds:w-full ds:h-48 ds:object-cover ds:rounded-lg"
            />
...
const CustomConfigDemo = () => {
  ...
  return (
    <div>
      <div
        className="ds:relative ds:cursor-pointer ds:inline-block ds:group"
        onClick={() => setVisible(true)}
      >
        <img
    ...
    <div>
      <div className="ds:grid ds:grid-cols-3 ds:gap-3 ds:max-w-3xl">
        {galleryImages.map((img, index) => (
          <div
            key={index}
            className="ds:relative ds:group ds:cursor-pointer ds:overflow-hidden ds:rounded-lg"
            onClick={() => {
              setCurrentIndex(index);
              setVisible(true);
            }}
          >
            <img
              src={img.src}
              alt={img.alt}
              className="ds:w-full ds:h-40 ds:object-cover ds:transition-transform ds:group-hover:scale-110"
            />
