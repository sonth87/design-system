  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "ds:bg-background ds:data-[state=open]:animate-in ds:data-[state=closed]:animate-out ds:fixed ds:z-50 ds:flex ds:flex-col ds:gap-4 ds:shadow-lg ds:transition ds:ease-in-out ds:data-[state=closed]:duration-300 ds:data-[state=open]:duration-500",
          side === "right" &&
